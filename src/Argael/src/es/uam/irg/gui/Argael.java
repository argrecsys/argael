...
public class Argael {
    ...
    public static void main(String[] args) {
        ...
        System.out.format(">> Data folder: %s, Result folder: %s, File extension: %s, document language: %s\n", dataFolder, dataResult, fileExtension, lang);
        ...
        // Show ARGAEL gui
        showWinform(dataFolder, dataResult, fileExtension, components, relCategories, relIntents, qualityMetrics);
    }
     ...
     */
    private static void showWinform(String dataFolder, String resultFolder, String fileExtension, List<String> components, List<String> relCategories, List<String> relIntents, List<String> qualityMetrics) {
        try {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ...
            new ArgaelForm(dataFolder, resultFolder, fileExtension, components, relCategories, relIntents, qualityMetrics);
